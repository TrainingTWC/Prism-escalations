...
export default function TicketsPage() {
  ...
  return (
    ...
    >
      ...
      {selectMode && (
        <div
          className="flex items-center justify-between px-4 py-2.5 rounded-[10px] mb-3"
          style={{ background: 'var(--accent-dim)', border: '1px solid var(--accent)33' }}
        >
          <button
            onClick={toggleAll}
            className="flex items-center gap-2 text-[12px] font-semibold text-[var(--accent)]"
          >
            {allSelected
              ? <CheckSquare size={15} />
              : <Square size={15} />}
          ...
          {!confirmDelete ? (
            <>
              ...
              <div className="flex items-center gap-3">
                <button
                  onClick={exitSelectMode}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-[8px] text-[12px] font-semibold text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors"
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-1.5 rounded-[8px] text-[12px] font-bold transition-colors"
                  style={{
            ...
            <>
              <span className="text-[13px] font-semibold" style={{ color: 'var(--color-danger)' }}>
                Permanently delete {selected.size} ticket{selected.size > 1 ? 's' : ''}? This cannot be undone.
              </span>
              <div className="flex items-center gap-3">
                <button
                  onClick={() => setConfirmDelete(false)}
                  className="px-3 py-1.5 rounded-[8px] text-[12px] font-semibold text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors"
                  style={{ border: '1px solid var(--border-subtle)' }}
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={deleting}
                  className="flex items-center gap-1.5 px-4 py-1.5 rounded-[8px] text-[12px] font-bold transition-opacity"
                  style={{
